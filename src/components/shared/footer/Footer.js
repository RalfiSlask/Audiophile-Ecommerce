...
const Footer = () => {
  return (
    <footer className='w-full h-[654px] md:h-[400px] xl:h-[365px] bg-[#101010] mt-[120px] xl:mt-[160px] text-[white] text-center md:text-start flex justify-center items-center'>
