      ...
      <input
        ...
        className={`${
          error
            ...
            : 'border border-[#CFCFCF] hover:border-[#D87D4A] focus:border-[#D87D4A]'
        } cursor-pointer outline-none w-full h-[56px] px-[24px] flex-shrink-0 rounded-lg placeholder:opacity-40 text-[14px] font-bold leading-normal tracking-[0.25px]`}
        onChange={event => {
          handleChange(event);
        }}
      ></input>
