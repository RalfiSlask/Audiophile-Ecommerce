...
const ProductPreview = ({ product }) => {
  ...
  return (
    <div
      className={`${
        productNew ? 'h-[724px] md:h-[706px]' : 'h-[681px] md:h-[671px]'
      } flex flex-col items-center xl:h-[560px] justify-between w-full xl:w-[1110px] text-center xl:flex-row-reverse xl:text-start`}
    >
      ...
      <div
        className={`${
          productNew ? 'h-[340px] md:h-[302px] xl:h-[343px]' : 'h-[297px] md:h-[267px] xl:h-[308px]'
        } w-full md:w-[527px] xl:w-[445px] flex flex-col justify-between items-center xl:items-start`}
      >
        <div>
          {productNew && (
